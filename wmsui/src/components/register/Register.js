...
const Register = () => {
  ...
  return (<>
    <Container className="register-center-items mt-3">
      ...
      <h3 style={{ color:'red' }} className='mb-2'>Please fill the Form to register the user</h3>
      <Form noValidate validated={validated} onSubmit={handleSubmit} >
        ...
        <Form.Group as={Row} className="mb-3" controlId="formHorizontalCustomerType">
          <Col lg={{ span: 1, offset: 4 }} sm={12} md={6}>
            <Form.Label>
              Customer Type
            </Form.Label>
          ...
          <Col lg={{ span: 3 }} sm={12} md={6}>
            ...
            <Form.Select aria-label="types" value={customertype} onChange={(e) => { setCustomerType(e.target.value) }} required>
